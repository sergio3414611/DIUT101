        ...
        try {
            ...
            switch (operador) {
                case '+':
                    limpiar = true;
                    tienePunto = true;
                    jTFResultado.setText("" + modelo.sumar(numero));
                ...
                case '-':
                    limpiar = true;
                    tienePunto = true;
                    jTFResultado.setText("" + modelo.restar(numero));
                    //System.out.println(jTFResultado.getText());
                    break;
                case '*':
                    limpiar = true;
                    tienePunto = true;
                    jTFResultado.setText("" + modelo.multiplicar(numero));
                    //System.out.println(jTFResultado.getText());
                    break;
                case '/':
                    limpiar = true;
                    tienePunto = true;
                    jTFResultado.setText("" + modelo.dividir(numero));
                    //System.out.println(jTFResultado.getText());
                    break;
                default:
